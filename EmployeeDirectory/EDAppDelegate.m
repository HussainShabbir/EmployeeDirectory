...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    EDMasterViewController *controller = (EDMasterViewController*)navigationController.topViewController;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.HussainCode.EmployeeDirectory" in the application's documents directory.
